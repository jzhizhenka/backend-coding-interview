...
DATABASES = {
    "default": {
        ...
        "USER": os.environ.get("POSTGRES_USER", "photos"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "photos"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "RESTful API for browsing, searching, and managing photos.",
    "VERSION": "1.0.0",
